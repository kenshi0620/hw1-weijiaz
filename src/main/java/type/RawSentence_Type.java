...
public class RawSentence_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("type.RawSentence");
  ...
  public String getNumber(int addr) {
      ...
      jcas.throwFeatMissing("Number", "type.RawSentence");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "type.RawSentence");
